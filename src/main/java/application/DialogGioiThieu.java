...
public class DialogGioiThieu extends JDialog {
	...
	public DialogGioiThieu() {
		...
		JLabel lblnguynHngQunnotetaker = new JLabel("-Nguy\u1EC5n H\u1ED3ng Qu\u00E2n(Notetaker)-");
		lblnguynHngQunnotetaker.setFont(tahoma16);
		JLabel lbltngGiaBotimekeeper = new JLabel("-T\u0103ng Gia B\u1EA3o(Timekeeper)-");
		...
		JLabel lblHocTruyCp = new JLabel("Truy cập đường dẫn https:// để đến trang hướng dẫn chính của ứng dụng");
		lblHocTruyCp.setFont(tahoma16);
		lblHocTruyCp.setForeground(new Color(255, 0, 51));
			...
			gl_contentPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPanel.createSequentialGroup()
					...
					.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(lblHocTruyCp, GroupLayout.DEFAULT_SIZE, 653, Short.MAX_VALUE))
					.addContainerGap())
		);
