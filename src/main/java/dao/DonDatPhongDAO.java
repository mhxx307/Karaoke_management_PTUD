...
//			prepareStatement.setTimestamp(1, Timestamp.valueOf(LocalDateTime.now()));
	...
	public boolean updateTrangThaiDonDat_DaNhanPhong(String maDatPhong, int ngayht) {
		String sql = "Update Don_Dat_Phong\r\n" + "SET TrangThaiDon = N'Đã Nhận Phòng'\r\n"
				+ "Where MaDatPhong = ? and Day(ThoiGianVao) = ?";
		int rs = 0;
		...
		try {
			...
			prepareStatement.setInt(1, Integer.parseInt(stt));
			prepareStatement.setInt(2, ngayht);
